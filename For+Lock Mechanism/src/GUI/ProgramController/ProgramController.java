...
public class ProgramController {
    ...
    @FXML
    private TableColumn<Pair<Integer,Integer>,String> LocationColumnLock;
    @FXML
    private TableColumn<Pair<Integer,Integer>,String> ValueColumnLock;
    @FXML
    ...
    public void initialize() {
        ...
        LocationColumnLock.setCellValueFactory(p->new SimpleStringProperty(p.getValue().first.toString()));
        ValueColumnLock.setCellValueFactory(p->new SimpleStringProperty(p.getValue().second.toString()));
    }
    ...
    private void populateLockTable()
    {
        ...
        MyILockTable lockTable=programState.getLockTable();
        ArrayList<Pair<Integer,Integer>> lockEntries=new ArrayList<>();
        for(Map.Entry<Integer,Integer>entry:lockTable.getContent().entrySet())
        {
            lockEntries.add(new Pair<>(entry.getKey(),entry.getValue()));
        }
