        ...
        if (selectedStatement == null) {
            ...
            try {
                ...
                PrgState prg1 = new PrgState(new MyStack<IStmt>(), new MyDictionary<String, Value>(), new MyList<Value>(),
                        new MyFileTable<String, BufferedReader>(), new MyHeap(),new MyLockTable(), selectedStatement);
        ...
        IStmt ex11=new CompStmt(new VarDeclStmt("a",new RefType(new IntType())),
                ...
                new CompStmt(new ForStmt("v",new ValueExp(new IntValue(0)),
                        ...
                        new ForkStmt(new CompStmt(new PrintStmt(new VarExp("v")),
                                new AssignStmt("v",new ArithExp("*",new VarExp("v"),new ReadHeap(new VarExp("a"))))))),
                                new PrintStmt(new ReadHeap(new VarExp("a")))))));
                                                                ...
                                                                new CompStmt(new ForkStmt(
                                                                        new CompStmt(new ForkStmt(
                                                                                new CompStmt(new LockStmt("x"),
                                                                                        new CompStmt(new WriteHeap("v1", new ArithExp("-", new ReadHeap(new VarExp("v1")), new ValueExp(new IntValue(1)))),
                                                                                                new UnlockStmt("x")))
                                                                        ),
                                                                                new CompStmt(new LockStmt("x"),
                                                                                ...
                                                                                new CompStmt(new ForkStmt(
                                                                                        new CompStmt( new ForkStmt(
                                                                                                new CompStmt(new LockStmt("q"),
                                                                                                        new CompStmt(new WriteHeap("v2", new ArithExp("+", new ReadHeap(new VarExp("v2")), new ValueExp(new IntValue(5)))),
                                                                                                                new UnlockStmt("q")))
                                                                                        ),
                                                                                                new CompStmt(new LockStmt("q"),
