        ...
        if (selectedStatement == null) {
            ...
            try {
                ...
                PrgState prg1 = new PrgState(new MyStack<IStmt>(), symTableStack, new MyList<Value>(),
                        new MyFileTable<String, BufferedReader>(), new MyHeap(),procTable, selectedStatement);
...
//int a;int b; a=2+3*5;b=a+1;Print(b)
       ...
       allStatements.add(ex8);
        ...
        List<String> ProcSum = new ArrayList<>();
        ProcSum.add("a");
        ProcSum.add("b");
        procTable.put("sum", new Pair<>(ProcSum, sumProc));
        ...
        List<String> ProcProd = new ArrayList<>();
        ProcProd.add("a");
        ProcProd.add("b");
        procTable.put("product", new Pair<>(ProcProd, prodProc));
