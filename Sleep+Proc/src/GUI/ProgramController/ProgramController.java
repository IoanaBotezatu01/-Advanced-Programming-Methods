...
public class ProgramController {
    ...
    @FXML
    private TableColumn<Map.Entry<String, javafx.util.Pair<List<String>, IStmt>>, javafx.util.Pair<String, List<String>>> ProcNameColumn;

    @FXML
    private TableColumn<Map.Entry<String, javafx.util.Pair<List<String>, IStmt>>, String> ProcListColumn;
    ...
    public void initialize() {
        ...
        ProcNameColumn.setCellValueFactory(p->new SimpleObjectProperty<>(new javafx.util.Pair<String,List<String>>(p.getValue().getKey(),p.getValue().getValue().getKey())));
        ProcListColumn.setCellValueFactory(p->new SimpleStringProperty(p.getValue().getValue().getValue().toString()));
    }
