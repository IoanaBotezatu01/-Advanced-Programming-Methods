        ...
        if (selectedStatement == null) {
            ...
            try {
                ...
                PrgState prg1 = new PrgState(new MyStack<IStmt>(), new MyDictionary<String, Value>(), new MyList<Value>(),
                        new MyFileTable<String, BufferedReader>(), new MyHeap(),new MySemaphoreTable(), selectedStatement);
                        ...
                        new CompStmt(new AssignStmt("a",new ValueExp(new IntValue(1))),
                                new CompStmt(new AssignStmt("b",new ValueExp(new IntValue(2))),
                                        new CompStmt(new AssignStmt("c",new ValueExp(new IntValue(5))),
                                                new CompStmt(new SwitchStmt(new ArithExp("*",new VarExp("a"),new ValueExp(new IntValue(10))),new ArithExp("*",new VarExp("b"),new VarExp("c")),new CompStmt(new PrintStmt(new VarExp("a")),new PrintStmt(new VarExp("b"))),
        ...
        IStmt ex12 = new CompStmt(
                ...
                new CompStmt(
                        ...
                        new CompStmt(
                                ...
                                new CompStmt(
                                        new CreateSemaphoreStmt("cnt", new ReadHeap(new VarExp("v1"))),
                                        new CompStmt(
                                                new ForkStmt(
                                                        new CompStmt(
                                                                new AcquireStmt("cnt"),
                                                        ...
                                                        new ForkStmt(
                                                                new CompStmt(
                                                                        ...
                                                                        new CompStmt(
                                                                                new WriteHeap("v1", new ArithExp("*",  new ReadHeap(new VarExp("v1")), new ValueExp(new IntValue(10)))),
                                                                                new CompStmt(
                                                                                        new WriteHeap("v1", new ArithExp("*",  new ReadHeap(new VarExp("v1")), new ValueExp(new IntValue(2)))),
                                                                                        new CompStmt(
                                                                                                new PrintStmt(new ReadHeap(new VarExp("v1"))),
                                                                                                new ReleaseStmt("cnt")
                                                                                        )
